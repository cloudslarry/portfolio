...
export default function Document() {
  return (
    <Html lang="en">
      <Head>
        <meta property="og:title" content="Dev J Patel's Portfolio" />
        <meta property="og:description" content="Portfolio website showcasing my work as a PYTHON DEVELOPER/AI ML DEVELOPER" />
        {/* Remove the avatar image meta tag */}
        {/* <meta property="og:image" content="URL_TO_AVATAR_IMAGE" /> */}
